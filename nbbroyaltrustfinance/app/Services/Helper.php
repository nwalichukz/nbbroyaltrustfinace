...
class Helper extends Controller
{
    ...
    public static function getResidencyByInvCountry(){
      return ResidencyByInvestmentModel::where('id', '!=', null)->get();
    ...
    public static function getResidencyByRealEstateCountry(){
      return ResidencyByRealEstateModel::where('id', '!=', null)->get();
    }
   ...
   /**
     ...
     * 
     */
    public static function countries($country = null){
   ...
   if(!empty($country)){
      foreach($all_countries as $nation){
         if($nation['name']== $country){
            return substr($nation['dial_code'], 1, 6);
         }
      }
   }else{
