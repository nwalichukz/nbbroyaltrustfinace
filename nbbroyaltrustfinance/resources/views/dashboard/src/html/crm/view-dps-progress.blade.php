                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li>
                                                            <div class="dropdown">
                                                                <a href="#" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-calender-date"></em>
                                                        ...
                                                        <table class="nk-tb-list nk-tb-ulist">
                                                            ...
                                                            <tbody>
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col">
                                                                        <span>Personal<span class="dot dot-success d-lg-none ms-1"></span></span>
                                                                    </td>
                                                                    <td class="nk-tb-col">
                                                                        <span>$999.00</span>
                                                                    </td>
                                                                ...
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col">
                                                                        <span>Retirement<span class="dot dot-danger d-lg-none ms-1"></span></span>
                                                                    </td>
                                                                    <td class="nk-tb-col">
                                                                        <span>$700.00</span>
                                                                    </td>
                                                                    <td class="nk-tb-col tb-col-lg">
                                                                        <span class="badge badge-dot badge-dot-xs bg-danger">success</span>
                                                                    </td>
                                                                    <td class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions">
                                                                            <li>
                                                                ...
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col">
                                                                        <span>Company<span class="dot dot-success d-lg-none ms-1"></span></span>
                                                                    </td>
                                                                    <td class="nk-tb-col">
                                                                        <span>$260.00</span>
                                                                    </td>
                                                                    <td class="nk-tb-col tb-col-lg">
                                                                        <span class="badge badge-dot badge-dot-xs bg-success">failed</span>
                                                                    </td>
                                                                    <td class="nk-tb-col nk-tb-col-tools">
                                                                        <ul class="nk-tb-actions">
                                                                            <li>
                                                                ...
                                                                <tr class="nk-tb-item">
                                                                    ...
                                                                    <td class="nk-tb-col">
                                                                        <span>Savings<span class="dot dot-warning d-lg-none ms-1"></span></span>
                                                                    </td>
                                                                    <td class="nk-tb-col">
                                                                        <span>$180.00</span>
                                                                    </td>
