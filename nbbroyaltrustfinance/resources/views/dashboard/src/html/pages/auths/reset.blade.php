...
<head>
    ...
    <!-- Page Title  -->
    <title>Reset | MetroKapital</title>
    <!-- StyleSheets  -->
                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            ...
                            <img class="logo-dark logo-img logo-img-lg" src="{{ asset('dashboard/images/logo.png')}}" srcset="./images/logo-dark2x.png 2x" alt="logo-dark">
                            </a>
                        </div>
