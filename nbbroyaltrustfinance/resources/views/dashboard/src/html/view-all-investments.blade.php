                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">All Active Investments</h3>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <li><a href="{{url('/admin/end-investment/'.$inv->id)}}"><em class="icon ni ni-na"></em><span>End Investment</span></a></li>
                                                                                <li><a href="{{url('/user/delete-investment/'.$inv->id)}}"><em class="icon ni ni-na"></em><span>Delete</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
