...
@section('content')        
    ...
    <H6 style="color:red;"> JOINT ACC BALANCE: {{ number_format(Auth::user()->userWallet->balance_two)}} USD <a href="{{url('/user/get-transfer-from-joint-account')}}"><button>Transfer Funds </button></a></H6>
    </BR>
                                <div class="col-lg-6">
